namespace Silk.Data.SQL.ORM.Schema
{
	...
	public class EntityFieldBuilder<TValue, TEntity> : IEntityFieldBuilder
		where TEntity : class
	{
		private readonly EntityFieldDefinition<TValue, TEntity> _entityFieldDefinition;
		private EntityFieldAssemblage<TValue, TEntity> _assemblage;

		public EntityFieldBuilder(EntityFieldDefinition<TValue, TEntity> entityFieldDefinition)
		{
		...
		{
			_assemblage = new EntityFieldAssemblage<TValue, TEntity>(
