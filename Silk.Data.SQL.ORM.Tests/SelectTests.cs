...
FROM [FlatPoco];", sql);
		...
		public void GenerateSelectPocoWithSingleRelationshipSQL()
		{
			...
			Assert.AreEqual(@"SELECT [PocoWithSingleRelationship].[Id] AS [Id], [Data].[Id] AS [Data__IDENT], [Data].[Id] AS [Data_Id], [Data].[Data] AS [Data_Data]
